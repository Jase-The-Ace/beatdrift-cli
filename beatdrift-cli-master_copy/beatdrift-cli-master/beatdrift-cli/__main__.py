...
def main():
    ...
    parser = ArgumentParser(
        prog='aws_list_all',
        description=(
            'beatdrift-cli lists AWS resources on one account across regions and services. '
            'Saves result into json files, which can then be passed into this tool again '
    ...
    caches = subparsers.add_parser(
        ...
        description=(
            ...
            'The cache lives in your OS-dependent cache directory, e.g. ~/.cache/beatdrift-cli/'
        ),
    ...
    caches.add_argument(
        ...
        action='store_true',
        help=(
            'Instead of writing to the cache, update files packaged with beatdrift-cli. '
